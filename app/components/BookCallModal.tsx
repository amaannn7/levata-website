...
export default function BookCallModal({ open, onClose }: { open: boolean; onClose: () => void }) {
    ...
    useEffect(() => {
        ...
        const onKey = (e: KeyboardEvent) => { if (e.key === "Escape") { setSubmitted(false); onClose(); } };
                                    ...
                                    <>
                                        ...
                                        <form onSubmit={onSubmit} className="flex flex-col gap-4">
                                            ...
                                            <div className="mt-2 flex items-center justify-between gap-3 border-t border-white/[0.07] pt-4">
                                                ...
                                                <button
                                                    type="submit"
                                                    className="accent-button-surface relative rounded-full border px-5 py-2.5 text-sm font-medium text-white transition duration-200 cursor-pointer sm:py-3"
                                                >
                                                    Send Request
                                                </button>
                                            </div>
