...
// Brand color shown is the client's real color as a CSS variable set per item
const CLIENTS = [
    {
        name: "Google",
        color: "#4285F4",
...
function ClientItem({ client }: { client: typeof CLIENTS[0] }) {
    ...
    return (
        ...
        >
            <span
                style={{
                    color: hovered ? client.color : 'rgba(255,255,255,0.25)',
            ...
            <span
                ...
                style={{
                    color: hovered ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.25)',
                    transition: 'color 0.3s ease',
                }}
            >
                {client.name}
