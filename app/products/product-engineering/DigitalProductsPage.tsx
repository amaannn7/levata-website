...
const FOUNDER_CONSIDERATIONS = [
    ...
    "Scalability path for 10x growth",
...
const FAQS = [
    ...
    { q: "Will the MVP be scalable?", a: "Yes. We architect for scale from day one, infrastructure, codebase, and data architecture designed to support 10x and 100x growth without fundamental rebuilds." },
        ...
        <div ref={ref} className="relative w-full" style={{ aspectRatio: "5 / 4" }}>
            ...
            <svg viewBox="0 0 480 282" className="h-full w-full" fill="none">
                ...
                <motion.g initial={{ opacity: 0, y: 5 }}
                    ...
                    <text x="400" y="260" textAnchor="middle" fontFamily={MONO} fontSize="15" fontWeight="700" fill="white">3x</text>
